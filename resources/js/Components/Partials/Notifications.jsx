                ...
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-lg z-10 w-[500px]">
                        <p className="font-semibold text-lg mb-2">
                            Permintaan Perstujuan Admin Baru
                        </p>
                        <p className="text-sm text-gray-500 mb-6 pr-4">
                            Akun dengan nama (nama) memakai username (username) telah melakukan registrasi sebagi admin. Sebelum menyetujui pastikan dengan benar bahwa ini merupakan anggota Anda!
                        </p>
                        <div className="flex justify-end space-x-2">
                            ...
                            <button
                                ...
                                className="bg-gray-200 hover:bg-red-400 text-gray-800 font-semibold py-2 px-4 rounded-md"
                            >
                                Delete
                            </button>
                            <button
                                ...
                                className="bg-gray-200 hover:bg-green-400 text-gray-800 font-semibold py-2 px-4 rounded-md"
                            >
                                Setujui
                            </button>
                        </div>
