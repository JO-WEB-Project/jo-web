...
const HeadListAllOrder = () => {
  return (
      <div className="mb-4 bg-gray-100 bg-opacity-20 w-auto grid grid-cols-12 gap-2 rounded-lg border-[0.1px] border-black border-opacity-60 justify-center items-center">
